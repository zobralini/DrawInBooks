...
Upload `build/libs/drawinbooks-0.3.0.jar` — **not** the `-sources` one. The
...
That produces `paper/build/libs/drawinbooks-paper-0.3.0.jar`. Upload it as a
...
`drawinbooks-0.3.0.jar` as a **beta** with Fabric API as a required
